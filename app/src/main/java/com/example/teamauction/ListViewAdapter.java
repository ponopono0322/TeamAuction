...
public class ListViewAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textTextView = (TextView) convertView.findViewById(R.id.list_textview1);
        TextView textViewView = (TextView) convertView.findViewById(R.id.list_textview2);
